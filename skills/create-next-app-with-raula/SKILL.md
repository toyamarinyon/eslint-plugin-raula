...
1. Determine the four supported inputs before running the script:
   ...
   - If the user asks for oxlint, oxfmt, or explicitly says they don't want ESLint/Biome, use `oxlint`. Otherwise default to `eslint`.
